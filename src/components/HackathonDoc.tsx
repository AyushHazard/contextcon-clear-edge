export default function HackathonDoc() {
  return (
    <>
      ...
      <p className="text-gray-500 text-xs">Scope: 2-hour build | Crustdata API only</p>

      <h2 className="text-base font-semibold text-indigo-400 border-b border-gray-800 pb-1 mt-4">What We're Building</h2>
      ...
      <h2 className="text-base font-semibold text-indigo-400 border-b border-gray-800 pb-1 mt-4">Scope Decision</h2>
      <p>Out of the four pillars, we're building <strong className="text-white">two</strong> for the hackathon:</p>
      <div className="overflow-x-auto">
        <table className="w-full text-xs border-collapse">
          <thead>
            <tr>
              <th className="border border-gray-700 bg-gray-800 text-gray-200 font-semibold px-3 py-2 text-left">Pillar</th>
              <th className="border border-gray-700 bg-gray-800 text-gray-200 font-semibold px-3 py-2 text-left">In Scope?</th>
              <th className="border border-gray-700 bg-gray-800 text-gray-200 font-semibold px-3 py-2 text-left">Reason</th>
            </tr>
          </thead>
          <tbody>
            <tr className="bg-gray-900">
              <td className="border border-gray-700 text-gray-300 px-3 py-2">Competitor Analysis</td>
              <td className="border border-gray-700 text-green-400 px-3 py-2">✅ Yes — full focus</td>
              <td className="border border-gray-700 text-gray-300 px-3 py-2">Crustdata covers ~80% natively. Most demo-able. Clearest value.</td>
            </tr>
            <tr className="bg-gray-800/40">
              <td className="border border-gray-700 text-gray-300 px-3 py-2">Growth Analysis</td>
              <td className="border border-gray-700 text-green-400 px-3 py-2">✅ Yes — hiring signal only</td>
              <td className="border border-gray-700 text-gray-300 px-3 py-2">Hiring titles + role distribution is pure Crustdata and adds a sharp growth strategy inference story.</td>
            </tr>
            <tr className="bg-gray-900">
              <td className="border border-gray-700 text-gray-300 px-3 py-2">Product Analysis</td>
              <td className="border border-gray-700 text-red-400 px-3 py-2">❌ No</td>
              <td className="border border-gray-700 text-gray-300 px-3 py-2">Requires Google Trends + News API for the compelling signals.</td>
            </tr>
            <tr className="bg-gray-800/40">
              <td className="border border-gray-700 text-gray-300 px-3 py-2">Customer Understanding</td>
              <td className="border border-gray-700 text-red-400 px-3 py-2">❌ No</td>
              <td className="border border-gray-700 text-gray-300 px-3 py-2">Requires G2/Reddit scraping — no good Crustdata substitute.</td>
            </tr>
          </tbody>
        </table>
      </div>

      <h2 className="text-base font-semibold text-indigo-400 border-b border-gray-800 pb-1 mt-4">The User Flow</h2>
      <ol className="list-decimal list-outside pl-5 space-y-2">
        ...
        <li><em>(Onboarding only)</em> User enters their company domain (e.g. <code className="bg-gray-800 text-indigo-300 text-xs rounded px-1">retool.com</code>) — domain is saved to localStorage immediately.</li>
      ...
      <h3 className="text-sm font-semibold text-gray-200 mt-3">Persistence &amp; Refresh Behaviour</h3>
      ...
      <h2 className="text-base font-semibold text-indigo-400 border-b border-gray-800 pb-1 mt-4">Pages &amp; Screens</h2>

      <h3 className="text-sm font-semibold text-gray-200 mt-3">Screen 1 — Onboarding / Input</h3>
      <ul className="list-disc list-outside pl-5 space-y-1">
      ...
      <h3 className="text-sm font-semibold text-gray-200 mt-3">Screen 2 — Loading State</h3>
      <ul className="list-disc list-outside pl-5 space-y-1">
      ...
      <h3 className="text-sm font-semibold text-gray-200 mt-3">Screen 3 — The Brief</h3>
      ...
      <h2 className="text-base font-semibold text-indigo-400 border-b border-gray-800 pb-1 mt-4">What We're NOT Building</h2>
      <ul className="list-disc list-outside pl-5 space-y-1">
      ...
      <h2 className="text-base font-semibold text-indigo-400 border-b border-gray-800 pb-1 mt-4">Demo Script</h2>
      <ol className="list-decimal list-outside pl-5 space-y-2">
        <li>Open Clear Edge.</li>
        <li>Type a real, recognisable company domain (e.g. <code className="bg-gray-800 text-indigo-300 text-xs rounded px-1">notion.so</code> or <code className="bg-gray-800 text-indigo-300 text-xs rounded px-1">linear.app</code>).</li>
      ...
      <h2 className="text-base font-semibold text-indigo-400 border-b border-gray-800 pb-1 mt-4">Success Criteria</h2>
      <ul className="list-disc list-outside pl-5 space-y-1">
