export default function VisionDoc() {
  return (
    <>
      ...
      <h2 className="text-base font-semibold text-zinc-300 border-b border-zinc-800 pb-1 mt-4">The Problem</h2>
      ...
      <h2 className="text-base font-semibold text-zinc-300 border-b border-zinc-800 pb-1 mt-4">The Solution</h2>
      ...
      <h2 className="text-base font-semibold text-zinc-300 border-b border-zinc-800 pb-1 mt-4">Features</h2>

      <h3 className="text-sm font-semibold text-zinc-200 mt-3">1. Product Analysis</h3>
      <p className="text-zinc-500 text-xs italic">Understand where your product stands in the market — and where it's headed.</p>
      <ul className="list-disc list-outside pl-5 space-y-1">
      ...
      <h3 className="text-sm font-semibold text-zinc-200 mt-3">2. Growth Analysis</h3>
      <p className="text-zinc-500 text-xs italic">Know what growth strategies are working in your space — not generically, but for companies like yours.</p>
      <ul className="list-disc list-outside pl-5 space-y-1">
      ...
      <h3 className="text-sm font-semibold text-zinc-200 mt-3">3. Competitor Analysis</h3>
      <p className="text-zinc-500 text-xs italic">A live, structured brief on every competitor — who they are, how they're moving, and what they're building next.</p>
      <ul className="list-disc list-outside pl-5 space-y-1">
      ...
      <h3 className="text-sm font-semibold text-zinc-200 mt-3">4. Customer Understanding</h3>
      <p className="text-zinc-500 text-xs italic">Know your customer better than they know themselves — their sentiment, their needs, and how to reach them.</p>
      <ul className="list-disc list-outside pl-5 space-y-1">
      ...
      <h2 className="text-base font-semibold text-zinc-300 border-b border-zinc-800 pb-1 mt-4">Technical Overview</h2>

      <h3 className="text-sm font-semibold text-zinc-200 mt-3">The Core Approach</h3>
      ...
      <h3 className="text-sm font-semibold text-zinc-200 mt-3">Data Sources</h3>
      ...
      <h3 className="text-sm font-semibold text-zinc-200 mt-3">The Intelligence Layer</h3>
      ...
      <h3 className="text-sm font-semibold text-zinc-200 mt-3">Continuous Monitoring</h3>
      ...
      <h2 className="text-base font-semibold text-zinc-300 border-b border-zinc-800 pb-1 mt-4">Why Now</h2>
      ...
      <h2 className="text-base font-semibold text-zinc-300 border-b border-zinc-800 pb-1 mt-4">The North Star</h2>
